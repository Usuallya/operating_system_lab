...
int main(int argc,char* argv[]){
  ...
  10:	892e                	mv	s2,a1
    ...
    if(argc < 2){
  12:	4785                	li	a5,1
  14:	06a7d263          	bge	a5,a0,78 <main+0x78>
        fprintf(2,"error:xargs must have 1 parameter at least!\n");
    }

    int pid = fork();
  18:	00000097          	auipc	ra,0x0
  1c:	30a080e7          	jalr	778(ra) # 322 <fork>
    if(pid < 0){
  20:	06054663          	bltz	a0,8c <main+0x8c>
        fprintf(2,"error to fork");
        exit(1);
    }else if(pid == 0){
  24:	e151                	bnez	a0,a8 <main+0xa8>
  26:	898a                	mv	s3,sp
        //子进程
        char* newArgv[argc-1];
  28:	fff4879b          	addiw	a5,s1,-1
  2c:	078e                	slli	a5,a5,0x3
  2e:	07bd                	addi	a5,a5,15
  30:	9bc1                	andi	a5,a5,-16
  32:	40f10133          	sub	sp,sp,a5
  36:	858a                	mv	a1,sp
        for(int i = 1;i<argc;i++){
  38:	4785                	li	a5,1
  3a:	0297d363          	bge	a5,s1,60 <main+0x60>
  3e:	00890793          	addi	a5,s2,8
  42:	872e                	mv	a4,a1
  44:	ffe4869b          	addiw	a3,s1,-2
  48:	1682                	slli	a3,a3,0x20
  4a:	9281                	srli	a3,a3,0x20
  4c:	068e                	slli	a3,a3,0x3
  4e:	01090613          	addi	a2,s2,16
  52:	96b2                	add	a3,a3,a2
            newArgv[i-1] = argv[i];
  54:	6390                	ld	a2,0(a5)
  56:	e310                	sd	a2,0(a4)
        for(int i = 1;i<argc;i++){
  ...
  5c:	fed79ce3          	bne	a5,a3,54 <main+0x54>
        }
        exec(argv[1],newArgv);
  60:	00893503          	ld	a0,8(s2)
  64:	00000097          	auipc	ra,0x0
  68:	2fe080e7          	jalr	766(ra) # 362 <exec>
  6c:	814e                	mv	sp,s3
        // exit(0);
    }else{
        wait((int *)0);
  ...
  74:	2ba080e7          	jalr	698(ra) # 32a <exit>
        fprintf(2,"error:xargs must have 1 parameter at least!\n");
  78:	00000597          	auipc	a1,0x0
  7c:	7d058593          	addi	a1,a1,2000 # 848 <malloc+0xe8>
  80:	4509                	li	a0,2
  82:	00000097          	auipc	ra,0x0
  86:	5f2080e7          	jalr	1522(ra) # 674 <fprintf>
  8a:	b779                	j	18 <main+0x18>
        fprintf(2,"error to fork");
  8c:	00000597          	auipc	a1,0x0
  90:	7ec58593          	addi	a1,a1,2028 # 878 <malloc+0x118>
  94:	4509                	li	a0,2
  96:	00000097          	auipc	ra,0x0
  9a:	5de080e7          	jalr	1502(ra) # 674 <fprintf>
        exit(1);
  9e:	4505                	li	a0,1
  ...
  ae:	288080e7          	jalr	648(ra) # 332 <wait>
  b2:	bf75                	j	6e <main+0x6e>
...
putc(int fd, char c)
{
 ...
 3e0:	f6e080e7          	jalr	-146(ra) # 34a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 412:	48250513          	addi	a0,a0,1154 # 890 <digits>
 416:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4de:	3b6b8b93          	addi	s7,s7,950 # 890 <digits>
 ...
 61e:	26e90913          	addi	s2,s2,622 # 888 <malloc+0x128>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e6:	1c67b783          	ld	a5,454(a5) # 8a8 <freep>
 ...
 714:	00e6ea63          	bltu	a3,a4,728 <free+0x50>
{
 ...
 756:	14f73b23          	sd	a5,342(a4) # 8a8 <freep>
}
 75a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 788:	12453503          	ld	a0,292(a0) # 8a8 <freep>
 ...
 7b0:	0fc90913          	addi	s2,s2,252 # 8a8 <freep>
  if(p == (char*)-1)
 7b4:	5afd                	li	s5,-1
 7b6:	a88d                	j	828 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7b8:	00000797          	auipc	a5,0x0
 7bc:	0f878793          	addi	a5,a5,248 # 8b0 <base>
 7c0:	00000717          	auipc	a4,0x0
 7c4:	0ef73423          	sd	a5,232(a4) # 8a8 <freep>
 7c8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ea:	0ca73123          	sd	a0,194(a4) # 8a8 <freep>
      return (void*)(p + 1);
 ...
 838:	b7e080e7          	jalr	-1154(ra) # 3b2 <sbrk>
  if(p == (char*)-1)
