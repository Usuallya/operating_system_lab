...
int main(int argc,char const *argv[]){
  ...
  10:	3a4080e7          	jalr	932(ra) # 3b0 <pipe>
    pipe(p2);
  14:	fe040513          	addi	a0,s0,-32
  18:	00000097          	auipc	ra,0x0
  1c:	398080e7          	jalr	920(ra) # 3b0 <pipe>
    char buffer[1];
    int childPid = fork();
  20:	00000097          	auipc	ra,0x0
  24:	378080e7          	jalr	888(ra) # 398 <fork>
    if(childPid != 0){
  28:	c159                	beqz	a0,ae <main+0xae>
        //父进程
        close(p1[0]);
  2a:	fe842503          	lw	a0,-24(s0)
  2e:	00000097          	auipc	ra,0x0
  32:	39a080e7          	jalr	922(ra) # 3c8 <close>
        write(p1[1],"a",1);
  36:	4605                	li	a2,1
  38:	00001597          	auipc	a1,0x1
  3c:	88858593          	addi	a1,a1,-1912 # 8c0 <malloc+0xea>
  40:	fec42503          	lw	a0,-20(s0)
  44:	00000097          	auipc	ra,0x0
  48:	37c080e7          	jalr	892(ra) # 3c0 <write>
        close(p1[1]);
  4c:	fec42503          	lw	a0,-20(s0)
  50:	00000097          	auipc	ra,0x0
  54:	378080e7          	jalr	888(ra) # 3c8 <close>
        //关闭管道2的写端
        close(p2[1]);
  58:	fe442503          	lw	a0,-28(s0)
  5c:	00000097          	auipc	ra,0x0
  60:	36c080e7          	jalr	876(ra) # 3c8 <close>
        if(read(p2[0],buffer,1) > 0){
  64:	4605                	li	a2,1
  66:	fd840593          	addi	a1,s0,-40
  6a:	fe042503          	lw	a0,-32(s0)
  6e:	00000097          	auipc	ra,0x0
  72:	34a080e7          	jalr	842(ra) # 3b8 <read>
  76:	00a04d63          	bgtz	a0,90 <main+0x90>
            fprintf(1,"%d:received pong\n",getpid());
        }
        close(p2[0]);
  7a:	fe042503          	lw	a0,-32(s0)
  7e:	00000097          	auipc	ra,0x0
  82:	34a080e7          	jalr	842(ra) # 3c8 <close>
        close(p2[0]);
        //在管道2的写端写入
        write(p2[1],"a",1);
        close(p2[1]);
  ...
  8c:	318080e7          	jalr	792(ra) # 3a0 <exit>
            fprintf(1,"%d:received pong\n",getpid());
  90:	00000097          	auipc	ra,0x0
  94:	390080e7          	jalr	912(ra) # 420 <getpid>
  98:	862a                	mv	a2,a0
  9a:	00001597          	auipc	a1,0x1
  9e:	82e58593          	addi	a1,a1,-2002 # 8c8 <malloc+0xf2>
  a2:	4505                	li	a0,1
  a4:	00000097          	auipc	ra,0x0
  a8:	646080e7          	jalr	1606(ra) # 6ea <fprintf>
  ac:	b7f9                	j	7a <main+0x7a>
        close(p1[1]);
  ae:	fec42503          	lw	a0,-20(s0)
  b2:	00000097          	auipc	ra,0x0
  b6:	316080e7          	jalr	790(ra) # 3c8 <close>
        if(read(p1[0],buffer,1) > 0){
  ba:	4605                	li	a2,1
  bc:	fd840593          	addi	a1,s0,-40
  c0:	fe842503          	lw	a0,-24(s0)
  c4:	00000097          	auipc	ra,0x0
  c8:	2f4080e7          	jalr	756(ra) # 3b8 <read>
  cc:	04a04063          	bgtz	a0,10c <main+0x10c>
        close(p1[0]);
  d0:	fe842503          	lw	a0,-24(s0)
  d4:	00000097          	auipc	ra,0x0
  d8:	2f4080e7          	jalr	756(ra) # 3c8 <close>
        close(p2[0]);
  dc:	fe042503          	lw	a0,-32(s0)
  e0:	00000097          	auipc	ra,0x0
  e4:	2e8080e7          	jalr	744(ra) # 3c8 <close>
        write(p2[1],"a",1);
  e8:	4605                	li	a2,1
  ea:	00000597          	auipc	a1,0x0
  ee:	7d658593          	addi	a1,a1,2006 # 8c0 <malloc+0xea>
  f2:	fe442503          	lw	a0,-28(s0)
  f6:	00000097          	auipc	ra,0x0
  fa:	2ca080e7          	jalr	714(ra) # 3c0 <write>
        close(p2[1]);
  fe:	fe442503          	lw	a0,-28(s0)
 102:	00000097          	auipc	ra,0x0
 106:	2c6080e7          	jalr	710(ra) # 3c8 <close>
 10a:	bfb5                	j	86 <main+0x86>
            fprintf(1,"%d:received ping\n",getpid());
 10c:	00000097          	auipc	ra,0x0
 110:	314080e7          	jalr	788(ra) # 420 <getpid>
 114:	862a                	mv	a2,a0
 116:	00000597          	auipc	a1,0x0
 11a:	7ca58593          	addi	a1,a1,1994 # 8e0 <malloc+0x10a>
 11e:	4505                	li	a0,1
 120:	00000097          	auipc	ra,0x0
 124:	5ca080e7          	jalr	1482(ra) # 6ea <fprintf>
 128:	b765                	j	d0 <main+0xd0>
...
free(void *ap)
{
 ...
 75c:	1c07b783          	ld	a5,448(a5) # 918 <freep>
 ...
 78a:	00e6ea63          	bltu	a3,a4,79e <free+0x50>
{
 ...
 7cc:	14f73823          	sd	a5,336(a4) # 918 <freep>
}
 7d0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fe:	11e53503          	ld	a0,286(a0) # 918 <freep>
 ...
 826:	0f690913          	addi	s2,s2,246 # 918 <freep>
  if(p == (char*)-1)
 82a:	5afd                	li	s5,-1
 82c:	a88d                	j	89e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 82e:	00000797          	auipc	a5,0x0
 832:	0f278793          	addi	a5,a5,242 # 920 <base>
 836:	00000717          	auipc	a4,0x0
 83a:	0ef73123          	sd	a5,226(a4) # 918 <freep>
 83e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 860:	0aa73e23          	sd	a0,188(a4) # 918 <freep>
      return (void*)(p + 1);
